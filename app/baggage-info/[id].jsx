      ...
      >
        ...
        {allowance.personalItem && (
          <Animated.View
            ...
            className="mx-6 mt-4 bg-green-500/10 rounded-[24px] p-5 border border-green-500/20"
          >
        ...
        {allowance.priority && (
          <Animated.View
            ...
            className="mx-6 mt-4 bg-primary/10 rounded-[24px] p-5 border border-primary/20"
          >
            <View className="flex-row items-center mb-3">
        ...
        >
          ...
          <View className="gap-2">
            ...
            <Text className="text-xs font-urbanist-medium text-primary/60">
              • Prohibited items include sharp objects, flammable materials, and
              explosives
            </Text>
            <Text className="text-xs font-urbanist-medium text-primary/60">
              • Liquids in cabin baggage must be in containers of 100ml or less
            </Text>
            <Text className="text-xs font-urbanist-medium text-primary/60">
